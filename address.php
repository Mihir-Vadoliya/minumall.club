...
<div class="appHeader1" style="background-color:#F14625 !important">
 ...
 <a href="add_address.php"><i class="fa fa-plus" ></i></a> 
...
while($bankResult=mysqli_fetch_array($selectBankQuery)){
        ...
        <div class="card mb-3">
                <div class="card-body">
                    <p><b>Name:</b>&nbsp;&nbsp;&nbsp; &nbsp;<?php echo $bankResult['name'];?></p>
                    <p><b>Mobile:</b>&nbsp;&nbsp;&nbsp; &nbsp;<?php echo $bankResult['mobile'];?></p>
                    <p><b>Pincode:</b>&nbsp;&nbsp;&nbsp; &nbsp;<?php echo $bankResult['pincode'];?></p>
                    <p><b>State:</b>&nbsp;&nbsp;&nbsp; &nbsp;<?php echo $bankResult['state'];?></p>
                    <p><b>City:</b>&nbsp;&nbsp;&nbsp; &nbsp;<?php echo $bankResult['city'];?></p>
                    <p><b>Adrress:</b>&nbsp;&nbsp;&nbsp; &nbsp;<?php echo $bankResult['address'];?></p>
                    <p style="margin-left:90%;"><a href="delete_address.php?id=<?php echo $bankResult['id'];?>" title="Delete"><i class="fa fa-trash" style="color:red;"></i></a></p>
                    <p style="margin-left:90%;"><a href="edit_address.php?id=<?php echo $bankResult['id'];?>" title="Edit"><i class="fa fa-edit" style="color:green;"></i></a></p> 
                </div>
            </div>
