 ...
 <?php include ("include/navigation.inc.php");?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <button class="button1" onclick="window.open('manage_user.php', '_blank')">Check Eligiblity</button>&nbsp&nbsp <p style="font-weight:bold;">(Please Deduct Charges Accordingly)</p>
<!--button class="button2" onclick="window.open('https://www.google.com', '_blank')">Button 2</button-->
