  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <?php
            ...
            $game_bet = mysqli_query($con, "SELECT SUM(amount) AS total_amount FROM `tbl_walletsummery` WHERE userid = '$userid' AND actiontype = 'recharge'");
    $wallet = mysqli_query($con, "SELECT *, amount FROM `tbl_wallet` WHERE userid = '".$userid."'");
    $with_amt = mysqli_query($con, "SELECT SUM(amount) AS with_amount FROM `tbl_withdrawal` WHERE userid = '$userid' AND status = '0'");

$game_bet_row = mysqli_fetch_assoc($game_bet);
$wallet_row = mysqli_fetch_assoc($wallet);
$with_amt_scs = mysqli_fetch_assoc($with_amt);

$with_amount = $with_amt_scs['with_amount'];
$game_bet_amount = $game_bet_row['total_amount'];
$wallet_amount = $wallet_row['amount'];

$balance = $wallet_amount - $game_bet_amount;
        ...
        <div class="row uinfo">
            ...
            <!--button class="button1" onclick="location.href='https://www.example.com'">Button 1</button-->
            <button class="button2" onclick="location.href='manage_user.php'">Back</button>
        ...
        <div class="row user-box" style="margin:0px;padding:0px;width:100%;">
            ...
            <div class="col-md-3 col-sm-12 col-lg-3 uinfo" style="margin-right:0 !important">
                ...
                <h2><?php echo '₹ ' . number_format($balance, 2);?></h2><p> + Requested Value</p><a href="https://app.triumphantclub.live/Youradmin/manage_withdraw.php">Give Withdrawal</a>
            </div>
        </div>
