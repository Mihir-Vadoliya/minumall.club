...
<?php include ("include/header.inc.php");?>
 ...
 <?php include ("include/navigation.inc.php");?> 
  ...
  <div class="content-wrapper" style="min-height: 644px !important;">
  ...
  <form id="formID" name="formID" method="post" action="#" enctype="multipart/form-data">
          ...
          <div class="margin-bottom">&nbsp;</div>
              ...
              <select style="width:300px !important;" class="select2 form-control" name="userid" id="userid">
 ...
 <div class="col-sm-12">
     <h3 class="text-center text-capitalize text-maroon">Filter By Date</h3></div>
              <div class="col-md-6">
              <div class="form-group">
