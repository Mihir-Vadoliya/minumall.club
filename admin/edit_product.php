...
if(isset($_POST['Action'])){
	...
	$affiliate_link=mysqli_real_escape_string($con,$_POST['affiliate_link']);
	$id=$_POST['editid'];
...
$sql2="update `tbl_product` set `images`='$des2' where `id`='$id'"; 
 ...
 $sql2= "UPDATE `tbl_product` SET `name`='".$name."',`price`='".$price."' ,`affiliate_link`='".$affiliate_link."' WHERE `id`='$id'";
   ...
   <textarea class="form-control" id="name" name="name" type="text" required style="height:100px;"><?php echo $role['name'];?></textarea>
    ...
    <input class="form-control"  id="price" name="price" type="text" value="<?php echo $role['price'];?>">
         ...
         <input class="form-control"  id="images" name="images" type="file" value="" >
                ...
                <div class="col-md-12 col-sm-6 col-xs-12">
                  <div class="form-group">
                  <label for="price">Affiliate link <span>*</span></label>
    <input class="form-control"  id="affiliate_link" name="affiliate_link" type="text" value="<?php echo $role['affiliate_link'];?>" >
