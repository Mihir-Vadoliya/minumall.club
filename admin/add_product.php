...
if(move_uploaded_file($path,$des1))	
 ...
 $sql= "INSERT INTO `tbl_product`(`name`,`price`,`images`,`affiliate_link`,`status`) VALUES ('".$name."','".$price."','".$des."','".$affiliate_link."','1')";
...
<?php include ("include/header.inc.php");?>
 <?php include ("include/navigation.inc.php");?>
   ...
   <textarea class="form-control" id="name" name="name" type="text" value="" required style="height:100px;"></textarea>
    ...
    <input class="form-control"  id="affiliate_link" name="affiliate_link" type="text" value="" >
