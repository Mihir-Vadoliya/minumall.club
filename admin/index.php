...
<head>
  ...
  <title>Colourfun Admin | Log in</title>
...
<!--<center class=""> <img src="images/logo.jpg" class="" alt="logo"> </center>-->
  ...
  <div class="login-logo">
      <div><img src="wincolor.png" style="height:150px;"></div>
  Wincolor Admin Login
 <h5> <?php if(isset($_GET['err'])=="ture") { ?>
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg">Signin To Manage The System</p>
