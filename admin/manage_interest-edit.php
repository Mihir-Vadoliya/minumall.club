                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                $interest_id = $_GET['id'];
                                $selectquery = "SELECT * FROM `interest` WHERE id='$interest_id'";
                                $query = mysqli_query($con, $selectquery);
                                while ($row = mysqli_fetch_array($query)) {
                                ?>
                                    <form method="post" action="interestbe.php" enctype="multipart/form-data">
                                        <div class="modal-body">
                                        <h4 class="modal-title" id="chn">Add Main ROI</h4>
                                            <div class="row mt-3">
                                                <div class="col-lg-6">
                                                    <div class="">
                                                        <label for="uploadexcel">Minimum Amount</label>
                                                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                                        <input type="number" name="min_balance" value="<?php echo $row['min_balance']; ?>" class="form-control" >
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="">
                                                        ...
                                                        <input type="text" name="rate_interest" value="<?php echo $row['rate_interest']; ?>" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <a href="manage_interest.php"><button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button></a>
