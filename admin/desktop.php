...
<head>
   ...
   <title>MINU Mall Admin | Dashboard</title>
...
<body class="hold-transition skin-red sidebar-mini">
   <div class="wrapper">
      ...
      <div class="content-wrapper">
                  ...
                  <div class="panel-heading">
                     <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                           ...
                           <div class="huge">
                              <?php
                              $sql = "SELECT * from `tbl_walletsummery` where `actiontype`='recharge' and `status` = '1' ";
                  ...
                  <div class="panel-heading">
                     <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                           ...
                           <div>Total Recharge Request</div>
                           <div class="huge">
                              <?php
                              $sql = "SELECT * from `tbl_walletsummery` where `actiontype`='recharge' and `status` = '0'";
                              if ($tbl_walletsummery1 = mysqli_query($con, $sql)) {
                                 $rowcount1 = mysqli_num_rows($tbl_walletsummery1);
                                 printf(" %d\n", $rowcount1);
                              }
                              ?>
                           </div>
         ...
         <h5 style="text-align:center; font-weight:bold;"><a href="manage_winresult.php">Manage Win Result</a></h5>
         <!-- /.content -->
      </div>
      <!-- /.content-wrapper -->
