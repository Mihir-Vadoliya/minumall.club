...
<body>
  ...
  <div class="appHeader1" style="background-color:#F14625 !important">
    <div class="left"> <a href="#" onClick="goBack();" class="icon goBack"> <i class="icon ion-md-arrow-back"></i> </a>
      <div class="pageTitle">My Play Record</div>
    </div>
  </div>
                  ...
                  <tr>
                    <td>
                      <div class="listItem">
                        ...
                        <div class="text">
                          <div><strong>Join Period</strong><small><?php echo $convert; ?></small></div>
                        </div>
                      </div>
                    </td>
                    <td class="tdtext2">-<?php echo number_format($summeryResult['amount'], 2); ?></td>
                  ...
                  <tr>
                    <td>
                      <div class="listItem">
                        ...
                        <div class="text">
                          <div><strong>Period Win</strong><small><?php echo $convert; ?></small></div>
                        </div>
                      </div>
                    </td>
                    <td class="tdtext">+<?php echo number_format($summeryResult['amount'], 2); ?></td>
                  ...
                  <tr>
                    <td>
                      <div class="listItem">
                        ...
                        <div class="text">
                          <div><strong>Envelope</strong><small><?php echo $convert; ?></small></div>
                        </div>
                      </div>
                    </td>
                    <td class="tdtext">+<?php echo number_format($summeryResult['amount'], 2); ?></td>
                  ...
                  <tr>
                    <td>
                      <div class="listItem">
                        ...
                        <div class="text">
                          <div><strong>Reward</strong><small><?php echo $convert; ?></small></div>
                        </div>
                      </div>
                    </td>
                    <td class="tdtext">+<?php echo number_format($summeryResult['amount'], 2); ?></td>
          ...
          <td class="tdtext">+<?php echo number_format($summeryResult['amount'], 2); ?></td>
              ...
              <tr>
                <td colspan="2">
                  <div class="listItem">
                    <div class="text">
                      <div class="text-center"><strong>Transation not fount...</strong></div>
                    </div>
                  </div>
                </td>
