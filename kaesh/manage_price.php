...
if(isset($_GET['del']))
{
    ...
    $dellid = $_GET['del'];
 	...
 	$sqlDel = "Delete from `pricer` where `id` in ($dellid) ";
...
if(isset($_POST['add'])){
 ...
 include ("include/connection.php");
   ...
   $sql= "INSERT INTO `pricer`(`amount`,`com`) VALUES ('". $amount ."','". $bonus ."')";
 ...
 <?php include ("include/navigation.inc.php");?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Manage  Referral Amount</h1>
      <ol class="breadcrumb">
        <li><a href="desktop.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Manage  Referral Amount</li>
      </ol>
    </section>
  ...
  <a data-toggle="modal" href="#excel" onclick="rolereset();" class="btn btn-block btn-danger" data-backdrop="static" data-keyboard="false">Add New</a>
            ...
            <form id="formID" name="formID" method="post" action="#" enctype="multipart/form-data">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
     <?php
  $Query=mysqli_query($con,"select * from `pricer`");
  $i=0; 
                ...
                <tr>
                  ...
                  <td><?php echo @$row["com"]; ?></td>
                   ...
                   <td><a href="javascript:void(0);" class="update-person" title="Edit" onClick="typedata(<?php echo $row['id']; ?>,'roleedit')"><i class="fa fa-edit" style="font-size:16px;"></i></a> &nbsp;
                    <a href="manage_price.php?del=<?php echo @$row['id']; ?>"  class="update-person" style="color:#f56954; font-size:16px;" title="Delete"><i class="fa fa-trash"></i></a>
...
<div class="col-sm-10"></div>
  ...
  <div class="modal-dialog">
   ...
   <form  enctype="multipart/form-data" action="" method="post">
              ...
              <div class="col-lg-12">
              <div class="">
                  <label for="uploadexcel">Add Amount</label>  
   <input class="form-control" id="add_item" name="amount"  type="text" required>
                </div> 
                </div>
    ...
    <input class="form-control" id="editid" name="editid"  type="hidden">
          ...
          <div class="form-group ">
                  <label for="uploadexcel">Add Bonus</label> 
   <input id="material" name="bonus" class="form-control"  type="text">
                </div> 
                </div>
