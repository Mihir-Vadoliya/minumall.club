...
<div id="appCapsule">
  <div class="appContent1 mb-2">
    ...
    <form action="password_update.php" method="post" style="padding: 25px;">
    
      <div class="inner-addon left-addon">
      <i class="icon ion-md-phone-portrait"><a style="font-size:16px; color:#1B2C42 !important;height:50px !important;">+91</a></i>
        <!--<input type="text" name="email" id="email" class="form-control" placeholder="Verification Code">-->
    ...
    <div class="col-9">
      ...
      <i class="icon ion-md-albums"></i>
        <input type="text" name="login_otp" id="login_otp" class="form-control" onchange="checkFunction(this.value)" placeholder="Verification Code" required>
      </div>
      </div>
      
      <div class="col-3 pl-0">
          <a href="javascript:void(0);" class="btn btn-block btn-light otpbtn otbt" style="" id="reg_otp" onclick="myFunction()">Send OTP</a>
          </div>
      </div>
      <div class="inner-addon left-addon">
      ...
      <div class="text-center mt-3">
        <input type="submit" class="btn btn-light" id="submit" disabled style="width:264px; background-image: linear-gradient(
#F14625, 
#F14625);" value="Continue">
        </div>
      </div>
    </form>
  </div>
