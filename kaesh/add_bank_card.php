...
$data_sql="select * from tbl_bankdetail where account='$acc_no' and ifsc='$ifsc_code'";
$data_query=mysqli_query($con,$data_sql);
$data_Rows=mysqli_num_rows($data_query);
if($data_Rows==''){

$sql= "INSERT INTO tbl_bankdetail(userid,name,ifsc,bankname,account,mobile,email,type,status,state,city,address) VALUES ('$userid','$name','$ifsc_code','$bank_name','$acc_no','$mobile','$email','bank','1','$state','$city','$address')";
//print_r($sql);exit;
...
echo ("<script LANGUAGE='JavaScript'>
 ...
 echo ("<script LANGUAGE='JavaScript'>
  ...
  echo ("<script LANGUAGE='JavaScript'>
    window.alert('Information Already Exit');
    window.location.href='add_bank_card.php';
    </script>");  
}
}
