                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="edit_notice_management.php?notice_id=<?php echo $row['id']; ?>" class="update-person" title="Edit" onClick="typedata(<?php echo $row['id']; ?>,'roleedit')"><i class="fa fa-edit" style="font-size:16px;"></i></a> &nbsp;
                                                        <a href="delete_notice_management.php?notice_id=<?php echo $row['id']; ?>" onClick="delete_row(<?php echo $row['id']; ?>)" class="update-person" style="color:#f56954; font-size:16px;" title="Delete"><i class="fa fa-trash"></i></a>
