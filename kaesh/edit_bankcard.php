...
if($_POST['submit']!='')
{
    ...
    //$extra_no=$_POST['extra_no'];

$sql= "update tbl_bankdetail set
    name='$name',
    ifsc='$ifsc_code',
    bankname='$bank_name',
    account='$acc_no',
...
echo ("<script LANGUAGE='JavaScript'>
 ...
 echo ("<script LANGUAGE='JavaScript'>
    ...
    window.location.href='add_bank_card.php';
    </script>");   
}
...
$id= $_GET['id'];
$selectBankQuery=mysqli_query($con,"select * from `tbl_bankdetail` where `id`='".$id."'");
...
<div class="appHeader1" style="background-color:#F14625 !important">
  <div class="left"> <a href="#" onClick="goBack();" class="icon goBack"> <i class="icon ion-md-arrow-back"></i> </a>
    <div class="pageTitle">Edit Bank Card</div>
  </div>
...
<div id="appCapsule" class="pb-2">
	...
	<li >
	<p >Actual Name</p>
	<input type="text" name="name" required value="<?php echo $bankRows['name']; ?>">
	</li>
	<li>
	<p >IFSC Code</p>
	<input type="text" name="ifsc_code" required value="<?php echo $bankRows['ifsc']; ?>"> 
	</li>
	<li>
	<p >Bank Name</p>
	<input type="text"  name="bank_name" required value="<?php echo $bankRows['bankname']; ?>">
	</li>
	<li>
	<p >Bank Account</p>
	<input type="number" name="acc_no"  required value="<?php echo $bankRows['account']; ?>">
	</li>
	<li>
	<p >State / Territory</p>
	<input type="text" name="state" required value="<?php echo $bankRows['state']; ?>">
	</li>
	<li>
	<p >City</p>
	<input type="text" name="city" required value="<?php echo $bankRows['city']; ?>">
	</li>
	<li>
	<p >Address</p>
	<input type="text" name="address"  required value="<?php echo $bankRows['address']; ?>">
	</li>
	<li>
	<p >Mobile Number</p>
	<input type="number" name="mobile" value="<?php echo $val['mobile'];?>" readonly>
	</li>
	<li>
	<p >Email</p>
	<input type="email" name="email" value="<?php echo $val['email'];?>" readonly>
	</li>
	<!--<li>-->
	<!--<p >Account Phone Number</p>-->
	<!--<input type="number" name="extra_no" max-length="10">-->
	<!--</li>-->
	
	<!--<li>-->
	<!--<p >Verification Code</p>-->
	<!--<input type="text" placeholder="Verification Code" spellcheck="false" data-ms-editor="true" style="flex: 1 1 0%;">-->
	<!--<button class="gocode">-->
 <!--           OTP-->
 <!--         </button>-->
	<!--</li>-->
	...
	<!--<button class="ripple">Continue</button>-->
	</div>
