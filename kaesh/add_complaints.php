...
<div class="appHeader1" style="background-color:#F14625 !important">
  <div class="left"> <a href="#" onClick="goBack();" class="icon goBack"> <i class="icon ion-md-arrow-back"></i> </a>
    <div class="pageTitle">Add Complaints</div>
  </div>
...
<!-- App Capsule -->
<form action="complaints_save.php" method="post" >	
<div id="appCapsule" class="pb-2">
	...
	<li >
	<p >Type</p>
	 <select class="type custom-select" id="gender2" name="type" required>
	...
	<li>
	<p >Out Id</p>
	<input type="text" name="out_id" ></li>
	
	<li>
	<p >WhatsApp</p>
	<input type="number" name="mobile" maximum="10" required></li>
	
	<li>
	<p >Description</p>
	<textarea type="text" class="type" name="description" style="min-height:40px;" required></textarea></li>
	...
	<input type="submit" class="btn btn-primary" style="width:76%; background-color: #F14625 !important;background-image:none;" name="submit" value="Continue"  class="ripple">
	</div>
