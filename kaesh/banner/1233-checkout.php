...
if(isset($_POST['submit'])){
    ...
    $ref_num = mysqli_real_escape_string($con,$_POST['refrence']);
    $amt = mysqli_real_escape_string($con,$_POST['deposit']);
    $email = mysqli_real_escape_string($con,$_POST['email']);
    $uid = mysqli_real_escape_string($con,$_SESSION['frontuserid']);
...
?>
        ...
        <div class="title">
            <!--<img src="admin/<?php echo $row['qr_code']; ?>" width="150" height="150">-->
...
<div class="container">
    <ul class="nav nav-tabs">
         <li class="active"><a data-toggle="tab" href="#qrcode">QR CODE</a></li>
        <li ><a data-toggle="tab" href="#home">UPI</a></li>
        <!--<li><a data-toggle="tab" href="#menu1">BANK</a></li>-->
    </ul>

<div class="tab-content">
     <div id="qrcode" class="tab-pane fade in active">
        <h1><b>Step 1. <br>SCAN QRCODE </b></h1>
        <div class="box" style="margin-bottom: 0;">        
            <p style="margin-left:50px;">
            <img src="admin/<?php echo $row['qr_code']; ?>" width="200" height="200"> 
             <!--<img src="assets/img/qr_final.png" width="200" height="200">-->
            </p>
  ...
  <div id="home" class="tab-pane fade in">
        ...
        <div class="box" style="margin-bottom: 0;">        
            <p>
                ...
                <button class="btn copyBtn" data-clipboard-text="<?php echo $row['upi']; ?>">Copy</button>
            </p>
  ...
  <div id="menu1" class="tab-pane fade">    
        ...
        <div class="box" style="margin-bottom: 0;">
            ...
            <p>
                ...
                <span class="value"><?php echo $row['acc_no']; ?></span>
                <button  class="btn copyBtn" data-clipboard-text="<?php echo $row['acc_no']; ?>">Copy</button>
            </p>
            <p>
                <span class="label">IFSC Code&nbsp;:</span>
                <span class="value"><?php echo $row['ifsc_code']; ?></span>
                <button class="btn copyBtn" data-clipboard-text="<?php echo $row['ifsc_code']; ?>">Copy</button>
            </p>
             <p>
                <span class="label">Bank Name&nbsp;:</span>
                <span class="value"><?php echo $row['bank_name']; ?></span>
                <button class="btn copyBtn" data-clipboard-text="<?php echo $row['bank_name']; ?>">Copy</button>
            </p>
             <p>
                <span class="label">Name&nbsp;:</span>
                <span class="value"><?php echo $row['name']; ?></span>
                <button class="btn copyBtn" data-clipboard-text="<?php echo $row['name']; ?>">Copy</button>
            </p>
        </div>    
  </div>
</div>
<div>
<h1><b>Step 2.<br> Open online banking or wallet, transfer the amount to the QR Code or UPI  or Bank account</b></h1>
</div>
...
<form class="paymentRefForm" action="save.php" method="POST" autocomplete="off">
    <div class="form-group">
        ...
        <div><span style="color:#0081FF; font-size:12px;">* copy UTR number from your transaction and paste here</span></div>
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" name="deposit" value="<?php echo $_SESSION['userammount']; ?>" readonly>
    </div>
    <div class="form-group">
