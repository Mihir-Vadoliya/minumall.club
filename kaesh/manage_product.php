...
<head>
  ...
  <title>Adminsuit | Manage Products</title>
 ...
 <?php include ("include/navigation.inc.php");?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <a href="add_product.php" class="btn btn-danger">Add New</a>
  ...
  <img class="img-circle img-bordered-sm" src="<?php echo @$row["images"]; ?>">
                  </div></td>
            <td><?php echo @$row["affiliate_link"]; ?></td>
			  <td>
              <a href="manage_specification.php?id=<?php echo encryptor('encrypt', $row['id']); ?>" class="update-person text-orange" data-toggle="tooltip" title="Product Specification"><i class="fa fa-plus-circle" style="font-size:16px;"></i></a>&nbsp;
			  <a href="edit_product.php?id=<?php echo encryptor('encrypt', $row['id']); ?>" class="update-person" data-toggle="tooltip" title="Edit"><i class="fa fa-edit" style="font-size:16px;"></i></a>&nbsp;
