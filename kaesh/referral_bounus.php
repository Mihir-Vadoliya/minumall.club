...
<body>
    ...
    <div class="appHeader1" style="background-color:#F14625 !important">
        <div class="left"> <a href="#" onClick="goBack();" class="icon goBack"> <i class="icon ion-md-arrow-back"></i> </a>
            <div class="pageTitle">Referral Bonus</div> &nbsp &nbsp<p style="color:white;"></p>
        </div>
    </div>
            ...
            <div class="appContent1 listView">
                <table class="table table-borderless">
                    ...
                    <tbody>
                        ...
                        $summery = mysqli_query($con, "select * from `tbl_walletsummery` where `userid`='" . $userid . "' AND actiontype LIKE '%Referral%'  order by id desc");
                                ...
                                <tr>
                                    <td>
                                        <div class="listItem">
                                            ...
                                            <div class="text">
                                                <div><strong>Recharge</strong><small><?php echo $summeryResult['actiontype'] ?></small></div>
                                            </div>
                                        </div>
                                    </td>
