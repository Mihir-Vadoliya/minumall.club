...
if($_POST['submit']!='')
{
    ...
    if($bankRows == 0){
    $sql= "INSERT INTO tbl_address(userid,name,mobile,pincode,state,city,address) VALUES ('$userid','$name','$mobile','$pincode','$state','$city','$address')";
...
<div id="appCapsule" class="pb-2">
	...
	<li >
	<p >Full Name</p>
	<input type="text" spellcheck="false" data-ms-editor="true" name="name">
	</li>
	...
	<li >
	<p >Pincode</p>
	<input name="pincode"  type="number" spellcheck="false" data-ms-editor="true">
	</li>
	
	<li >
	<p >State</p>
	<input name="state"  type="text" spellcheck="false" >
	</li>
	
	<li >
	<p >Town/City</p>
	<input name="city"  type="text" spellcheck="false" >
	</li>
	
	<li >
	<p >Detail Address</p>
	<input name="address"  type="text" spellcheck="false" >
	</li>
	...
	<input class="btn btn-primary" style="width:76%; background-color: #F14625 !important;background-image:none;" type="submit" name="submit"  value="Continue" class="ripple">
	</div>
	</form>
