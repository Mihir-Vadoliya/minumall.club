...
<h2 style="font-weight:normal; font-size: 22px;" class="text-center m-2">Balance: <span>₹
<span id="amounter"><?php echo number_format(wallet($con,'amount',$userid), 2);?></span>
</span></h2>
    <form action="wallet_to_logic.php"  method="post"  autocomplete="off">
        
        
        <input type="hidden" name="muserid" value="<?php echo $_SESSION['frontuserid']; ?>">
      ...
      <i class="icon ion-md-wallet"></i>
        <input type="text" name="userid" class="form-control"  placeholder="Enter Number" >
      </div>
      
      <div class="inner-addon left-addon">
      <i class="icon ion-md-wallet"></i>
        <input type="number" id="userammount" name="userammount" class="form-control" value="" placeholder="Enter recharge amount" required >
      </div>
        ...
        ?>
           ...
           <script>
               function myfunction(val)
               {
                  ...
                  document.getElementById("userammount").value = val;
               }
           </script> 
    ...
    <div class=" text-center ">
        <input type="submit" class="btn btn-primary" id="submitter" style="width:76%;background-color:#F14625 !important;background-image: none;" value="Recharge">  
        
        <!--<input type="button" class="btn btn-primary" id="submitter2" style="width:76%;background-color:#F14625 !important;background-image: none;" value="Recharge">  -->
...
$('#mainid').keyup(function(){
    
     var text1 = document.getElementById('mainid').value; 
       var now = parseInt(text1,10);
     
        document.getElementById('secondid').value = now;
