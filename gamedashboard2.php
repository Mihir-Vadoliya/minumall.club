...
.btn4 {
    ...
    background: #37b844;
    background: linear-gradient(316deg, rgb(76, 175, 80) 48%, rgba(156,39,176,1) 49%) !important;
}
...
<div class="vcard" >
  <div class="appContent3 text-white" style="background-color:#F14625 !important;">
    <div class="row">
      ...
      <div class="col-12">
          <div> <a href="recharge.php" class="btn btn-blue btn-blue m-0">Recharge</a> <!--<a  href="trend.php" class="btn " style="background-color:#dee2e6 !important;color:#000 !important;">Read Rule</a>--> <!--data-toggle="modal" href="#rule" data-backdrop="static" data-keyboard="false"-->
          
          <a href="gamedashboard.php" onClick="reloadbtn(<?php echo $userid;?>);" class="reaload text-white pull-right mt-1" onclick="getResultbyCategory(sapre,sapre)"> <i class="icon ion-md-refresh"></i></a></div>
        </div>
      </div>
    </div>
  </div>
...
<a class="nav-link" id="contact-tab3" data-toggle="tab" href="#emerd" role="tab" onClick="tabname('emerd');getResultbyCategory('emerd','emerd');">Emerd</a>
     ...
     <div class="container-fluid all_btn ">
      ...
      <div class="divsize2">
      <button type="button" class="btn btn-lg w-d btn3 gbutton none btn-blue" onClick="betbutton('#18FFFF','button','0');">0</button>
      </div>
      <div class="divsize2">
      <button type="numbutton"  class="btn btn-lg btn-success w-d gbutton none" onClick="betbutton('#18FFFF','button','1');">1</button>
      </div>
      
      <div class="divsize2">
      <button type="button"  class="btn btn-lg w-d btn-danger gbutton none" onClick="betbutton('#18FFFF','button','2');">2</button>
      </div>
      
      <div class="divsize2">
      <button type="button"  class="btn btn-lg w-d btn-success gbutton none" onClick="betbutton('#18FFFF','button','3');">3</button>
      </div>
      
      <div class="divsize2">
      <button type="button"  class="btn btn-lg w-d btn-danger gbutton none" onClick="betbutton('#18FFFF','button','4');">4</button>
      </div>
      ...
      <div class="divsize2">
      <button type="button"  class="btn btn-lg w-d btn-success btn4 btn-blue gbutton none" onClick="betbutton('#18FFFF','button','5');">5 </button>
      </div>
      
      <div class="divsize2">
      <button type="button"  class="btn btn-lg w-d btn-danger gbutton none" onClick="betbutton('#18FFFF','button','6');"> 6</button>
      </div>
      
      <div class="divsize2">
      <button type="button"  class="btn btn-lg w-d btn-success gbutton none" onClick="betbutton('#18FFFF','button','7');">7 </button>
      </div>
      <div class="divsize2">
      <button type="button"  class="btn btn-lg w-d btn-danger gbutton none" onClick="betbutton('#18FFFF','button','8');"> 8</button>
      </div>
      <div class="divsize2">
      <button type="button"  class="btn btn-lg w-d btn-success gbutton none" onClick="betbutton('#18FFFF','button','9');">9 </button>
      </div>
      </div>
