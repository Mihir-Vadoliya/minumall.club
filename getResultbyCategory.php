...
?>
        ...
        <td><span style="color:<?php if ($parityResult['color'] == 'green') {
                    echo "#1DCC70";
                } else if ($parityResult['color'] == 'red') {
                    echo "#ff2d55";
                } else if ($parityResult['color'] == 'red+violet') {
                    echo "#ff2d55";
                } else if ($parityResult['color'] == 'green+violet') {
                    echo "#1DCC70";
                } ?>;"><?php echo $parityResult['result']; ?></span></td>
        <td>
        <div style="display: flex;">
        <div class="spacer"></div>
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
        ...
        <?php
            } else if ($parityResult['resulttype'] == 'random') { ?>
        <tr>
        <td><?php echo $parityResult['periodid']; ?></td>
        <td><?php echo $parityResult['randomprice']; ?></td>
        <td><span style="color:<?php if ($parityResult['randomcolor'] == 'green') {
                    echo "#1DCC70";
                } else if ($parityResult['randomcolor'] == 'red') {
                    echo "#ff2d55";
                } else if ($parityResult['randomcolor'] == 'red++violet') {
                    echo "#ff2d55";
                } else if ($parityResult['randomcolor'] == 'green++violet') {
                    echo "#1DCC70";
                } ?>;"><?php echo $parityResult['randomresult']; ?></span></td>
        <td>
        <div style="display: flex;">
        <div class="spacer"></div>
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
    ...
    <p> <i class="icon ion-md-paper"></i> <div class="title">My Parity Record</div> </p>
        ...
        <table class="table table-borderless" id="myrecordparity">
...
?>
        <tr data-toggle="collapse" data-target="#accordion<?php echo ($userResult['id']); ?>" class="clickable" style="border-bottom:1px solid #ccc;">
            ...
            <?php echo ($userResult['periodid']); ?> <span style="color:<?php if ($userResult['status'] == 'success') {
            echo "#1DCC70";
        } else {
            echo "#ff2d55";
        } ?>"> <?php echo ucfirst($userResult['status']); ?> <?php if ($userResult['status'] == 'success') {
            echo "+";
        } else {
            echo "-";
        } ?><?php echo number_format($userResult['paidamount'], 2); ?></span>
        ...
        $tt = explode("+", $userResult['resultcolor']);
        echo ucwords(implode(" + ", $tt)); ?></div>
        </div>
        <div class="mt-1" style="display: flex;">
        <div class="point2">Select</div>
        <div class="point2" style="color:<?php if ($userResult['status'] == 'success') {
            echo "#1DCC70";
        } else {
            echo "#ff2d55";
        } ?>"><?php echo $userResult['value']; ?></div>
        </div>
        <div class="mt-1" style="display: flex;">
        ...
        <div class="point2" style="color:<?php if ($userResult['status'] == 'success') {
            ...
            echo "#ff2d55";
        } ?>;"><?php echo ucfirst($userResult['status']); ?></div>
        </div>
        <div class="mt-1" style="display: flex;">
        ...
        <div class="point2" style="color:<?php if ($userResult['status'] == 'success') {
            ...
            echo "#ff2d55";
        } ?>;"><?php if ($userResult['status'] == 'success') {
            echo "+";
        } else {
            echo "-";
        }
        echo number_format($userResult['paidamount'], 2); ?></div>
        </div>
        <div class="mt-1" style="display: flex;">
...
?>
        ...
        <td><span style="color:<?php if ($sapreResult['color'] == 'green') {
                    echo "#1DCC70";
                } else if ($sapreResult['color'] == 'red') {
                    echo "#ff2d55";
                } else if ($sapreResult['color'] == 'red+violet') {
                    echo "#ff2d55";
                } else if ($sapreResult['color'] == 'green+violet') {
                    echo "#1DCC70";
                } ?>;"><?php echo $sapreResult['result']; ?></span></td>
        <td>
        <div style="display: flex;">
        <div class="spacer"></div>
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
        ...
        <?php
            } else if ($sapreResult['resulttype'] == 'random') { ?>
        <tr>
        <td><?php echo $sapreResult['periodid']; ?></td>
        <td><?php echo $sapreResult['randomprice']; ?></td>
        <td><span style="color:<?php if ($sapreResult['randomcolor'] == 'green') {
                    echo "#1DCC70";
                } else if ($sapreResult['randomcolor'] == 'red') {
                    echo "#ff2d55";
                } else if ($sapreResult['randomcolor'] == 'red++violet') {
                    echo "#ff2d55";
                } else if ($sapreResult['randomcolor'] == 'green++violet') {
                    echo "#1DCC70";
                } ?>;"><?php echo $sapreResult['randomresult']; ?></span></td>
        <td>
        <div style="display: flex;">
        <div class="spacer"></div>
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
    ...
    <p> <i class="icon ion-md-paper"></i> <div class="title">My Sapre Record</div> </p>
        ...
        <div class="table-container">
        <table class="table table-borderless" id="myrecordsapre">
        <thead><tr><th></th></tr></thead>    
    <tbody>
...
?>
        ...
        <td><span style="color:<?php if ($bconeResult['color'] == 'green') {
                    echo "#1DCC70";
                } else if ($bconeResult['color'] == 'red') {
                    echo "#ff2d55";
                } else if ($bconeResult['color'] == 'red+violet') {
                    echo "#ff2d55";
                } else if ($bconeResult['color'] == 'green+violet') {
                    echo "#1DCC70";
                } ?>;"><?php echo $bconeResult['result']; ?></span></td>
        <td>
        <div style="display: flex;">
        <div class="spacer"></div>
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
        ...
        <?php
            } else if ($bconeResult['resulttype'] == 'random') { ?>
        <tr>
        <td><?php echo $bconeResult['periodid']; ?></td>
        <td><?php echo $bconeResult['randomprice']; ?></td>
        <td><span style="color:<?php if ($bconeResult['randomcolor'] == 'green') {
                    echo "#1DCC70";
                } else if ($bconeResult['randomcolor'] == 'red') {
                    echo "#ff2d55";
                } else if ($bconeResult['randomcolor'] == 'red++violet') {
                    echo "#ff2d55";
                } else if ($bconeResult['randomcolor'] == 'green++violet') {
                    echo "#1DCC70";
                } ?>;"><?php echo $bconeResult['randomresult']; ?></span></td>
        <td>
        <div style="display: flex;">
        <div class="spacer"></div>
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
    ...
    <p> <i class="icon ion-md-paper"></i> <div class="title">My Bcone Record</div> </p>
        ...
        <div class="table-container">
        <table class="table table-borderless" id="myrecordbcone">
        <thead><tr><th></th></tr></thead>    
    <tbody>
...
?>
        ...
        <td><span style="color:<?php if ($emerdResult['color'] == 'green') {
                    echo "#1DCC70";
                } else if ($emerdResult['color'] == 'red') {
                    echo "#ff2d55";
                } else if ($emerdResult['color'] == 'red+violet') {
                    echo "#ff2d55";
                } else if ($emerdResult['color'] == 'green+violet') {
                    echo "#1DCC70";
                } ?>;"><?php echo $emerdResult['result']; ?></span></td>
        <td>
        <div style="display: flex;">
        <div class="spacer"></div>
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
        ...
        <?php
            } else if ($emerdResult['resulttype'] == 'random') { ?>
        <tr>
        <td><?php echo $emerdResult['periodid']; ?></td>
        <td><?php echo $emerdResult['randomprice']; ?></td>
        <td><span style="color:<?php if ($emerdResult['randomcolor'] == 'green') {
                    echo "#1DCC70";
                } else if ($emerdResult['randomcolor'] == 'red') {
                    echo "#ff2d55";
                } else if ($emerdResult['randomcolor'] == 'red++violet') {
                    echo "#ff2d55";
                } else if ($emerdResult['randomcolor'] == 'green++violet') {
                    echo "#1DCC70";
                } ?>;"><?php echo $emerdResult['randomresult']; ?></span></td>
        <td>
        <div style="display: flex;">
        <div class="spacer"></div>
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
    ...
    <p> <i class="icon ion-md-paper"></i> <div class="title">My Emerd Record</div> </p>
        ...
        <div class="table-container">
        <table class="table table-borderless" id="myrecordemerd">
        <thead><tr><th></th></tr></thead>    
    <tbody>
