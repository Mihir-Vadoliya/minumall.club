...
<body>
    ...
    <span class="label-red">UPI ID</span>
    <span class="value-red"><?php echo $row['upi']; ?></span>
</div>

        
    <p><div id="p1" style="display:none;">demo@123</div></p>
    <button class="copyButton btn" onclick="copyToClipboard('p1')('<?php echo $row['upi_id']; ?>')">Copy UPI ID</button>
    
    
    <div style="text-align: center;">
      <p class="small-text">Click the button to copy the UPI ID:</p>
    <div style="text-align: center;">
                        <button class="my-button" onclick="window.location.href='upi://pay?pa=anil.ug@axl&pn=Anil Kumar UG&am=Amount&cu=INR&tn=Recharge'">Pay Now From UPI Apps</button>
                    </div>
    <strong>VPA/UPI:</strong>
